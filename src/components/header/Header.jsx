  ...
  return (
    <div className='header-row'>
        <div className="header-top">
            <span><FontAwesomeIcon icon={faPhone}/>+254703229589</span>
            <span><FontAwesomeIcon icon={faEnvelope}/>elijahobara357@gmail.com</span>
        </div>
        <div className="header-menu">
            <div className="header-logo">
                <Link to="/"><h2 className="header-logo-title">Obara enterprise</h2></Link>
            </div>
